...
### The main code
The code for training models on the HBV and dSprites tasks are in the files **/src/diffusion_gfn.py** and **/src/dsprites_gfn.py**, respectively.
### Training the models
...
```python generate_results.py --dynamics true --device -1 --same_point true --gif true --vectors true --load ..\hpc\models\binary_vec\gfn_fixed_double_400.pt --config configs\diffusion_fixed_double.yaml --content_name vector_sd_double```,
